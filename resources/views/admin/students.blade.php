...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">عام</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الطلاب</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
            ...
            <div class="card-header pb-0">
                <div class="card-header pb-0">
                    ...
                    data-toggle="modal" href="#modaldemo8"><i
                            class="fas fa-plus"></i>&nbsp; اضافة طالب جديد</a>
            ...
            <div class="card-header pb-0">
                <form action="{{ route('students.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-primary"><i
                        class="fas fa-plus"></i>&nbsp;رفع اكسيل شيت</button>
                </form>
            </div>
            <hr>
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-outline-success btn-sm"
                                                    data-student_name="{{ $student->student_name }}" data-id="{{ $student->id }}" data-toggle="modal"
                                                    data-target="#exampleModal2">تعديل</button>
                                            
                                                <button class="btn btn-outline-danger btn-sm " data-id="{{ $student->id }}"
                                                data-student_name="{{ $student->student_name }}" data-toggle="modal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">اضافة طالب جديد</h6><button aria-label="Close" class="close" data-dismiss="modal"
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">تعديل الطالب</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('Student.update','test') }}" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <label for="student_name" class="col-form-label">اسم الطالب:</label>
                            <input class="form-control" name="student_name" id="student_name" type="text" required>
                        </div>
                </div>
                <div class="modal-footer">
