...
@endsection
@section('title')
     تفاصيل التقرير - MOTIVATION RECREATED
@stop
@section('page-header')
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">قائمة التقارير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    تفاصيل التقرير</span>
            </div>
        </div>
            ...
            <div class=" main-content-body-invoice" >
                <div class="card card-invoice">
                    <div class="card-body" style="background-color: rgb(240, 237, 237); font-size: 16px;">
                        ...
                        <hr class="mg-b-40">
                        <a href="{{ route('print.report',$reports->id) }}" target="_blank" class="btn btn-danger float-left mt-3 mr-2">
